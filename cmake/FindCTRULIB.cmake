...
find_path (
    LIBCTRU_INCLUDE_DIR 3ds.h
    PATHS ${CTRULIB_PATHS}
    PATH_SUFFIXES include libctru/include
)

find_library (
    LIBCTRU_LIBRARY NAMES ctru libctru.a
    PATHS ${CTRULIB_PATHS}
...
# Handle the QUIETLY and REQUIRED arguments and set LIBCTRU_FOUND to TRUE if all listed variables are TRUE.
find_package_handle_standard_args (
    CTRULIB DEFAULT_MSG LIBCTRU_LIBRARY LIBCTRU_INCLUDE_DIR
)
